...
const Main = () => {
  ...
  className="relative inline-block rounded-full border border-yellow-100/40 px-6 py-2 text-sm hover:bg-black transition"
>
  Konumu Görüntüle
</Link>
        </motion.div>
...
>
  <GiftTracker />
        ...
        >
          <CardFlorals />
<div>
<p className='text-yellow-100 border-b py-2 px-16'>Düğünümüze katıldığınız için teşekkürler</p>
</div>
        </motion.div>
